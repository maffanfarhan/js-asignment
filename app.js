...
//  var email="muhammadaffanfarhan65@gamil.com";
...
function table(){
    for(var i=1; i<=10; i++){
        console.log(`${heading.value} *${i} = ${heading.value*i}`);
    }};


    var h1 = Document.querySelector("#table-printed");
    
    h1.innerhtml =   console.log(`${heading.value} *${i} = ${heading.value*i}`)
